...
[**日本語🗾**](/README.md) | [English🌎️](https://github.com/fuku2019/VRChat-OSC-Keyboard/blob/main/docs/en/README.en.md)
...
+ **日本語入力に最適化:** 内蔵キーボード（かな・カナ・英）で漢字変換が可能。
...
3. VRChatの設定: アクションメニュー ➔ オプション ➔ OSC ➔ Enabledを選択。
